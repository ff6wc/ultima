    ...
    <div className="flex-grow py-2 flex flex-col gap-6">
      ...
      <section className="relative py-6 px-4 text-center flex flex-col items-center">
        <div className="max-w-3xl mx-auto">
          <h1 className="text-3xl md:text-4xl font-outfit font-bold uppercase tracking-wide mb-2 text-[var(--text-main)]">
            Community Events
          </h1>
      ...
      <PageContainer columns={1} className="py-2 px-4 md:px-0">
        <>
          {isLoading && (
                    ...
                    <Disclosure key={idx} defaultOpen={section.defaultOpen}>
                      {({ open }) => (
                        <div className="flex flex-col gap-6">
                          <Disclosure.Button className="flex items-center justify-between w-full pb-3 border-b border-[var(--border-light)] hover:text-blue-500 transition-colors text-left group">
                            <h2 className="text-xl md:text-2xl font-bold uppercase tracking-wider text-[var(--text-main)] group-hover:text-blue-500 transition-colors font-outfit">
                              {section.title}
